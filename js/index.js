...
window.addEventListener(
  "keydown",
  e => (keyDown.style.backgroundColor = "red")
);
...
dragDrop.addEventListener(
  "drag",
  e => (dragDrop.style.border = "10px  solid black")
);

dragDrop.addEventListener(
  "mouseleave",
  e => (dragDrop.style.border = "15px dashed blue")
);

dblClick.addEventListener(
  "dblclick",
  e => (dblClick.style.backgroundColor = "red")
);
